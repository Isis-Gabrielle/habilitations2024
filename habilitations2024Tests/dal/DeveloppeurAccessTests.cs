...
namespace habilitations2024.dal.Tests
{
    ...
    public class DeveloppeurAccessTests
    {
        ...
        public void ControleAuthentificationTest()
        {
            ...
            string mail = "Vivamus.non@egestasSedpharetra.org";
            string pwd = "Nolan";
            Assert.IsTrue(developpeurAccess.ControleAuthentification(new Admin(nom, prenom, mail, pwd)),
                "devrait réussir : données utilisateur correctes");
            string erreurNom = "__";
            string erreurPrenom = "__";
            string erreurPwd = "__";
            Assert.IsFalse(developpeurAccess.ControleAuthentification(new Admin(erreurNom, prenom, mail, pwd)),
                "devrait échouer : nom incorrect");
            Assert.IsFalse(developpeurAccess.ControleAuthentification(new Admin(nom, erreurPrenom, mail, pwd)),
                "devrait échouer : prenom incorrect");
            Assert.IsFalse(developpeurAccess.ControleAuthentification(new Admin(nom, prenom, mail, erreurPwd)),
